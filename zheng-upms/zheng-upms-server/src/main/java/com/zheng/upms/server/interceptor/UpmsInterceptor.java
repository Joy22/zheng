...
public class UpmsInterceptor extends HandlerInterceptorAdapter{
    ...
    private static final String ZHENG_OSS_ALIYUN_POLICY = PropertiesFileUtil.getInstance("zheng-oss-client").get("zheng.oss.aliyun.oss.policy");
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        request.setAttribute("ZHENG_OSS_ALIYUN_POLICY", ZHENG_OSS_ALIYUN_POLICY);
        // 过滤ajax
