...
public class RedisUtil {
     ...
     * 一个月
     */
    public final static int EXRP_MOUTH = 60 * 60 * 24 * 30;
        ...
        try {
            if(null != jedisPool){
                ...
                try {
                    ...
                    LOGGER.error("Auth jedis error : " + e);
                }
            }
        }catch (Exception e){
    ...
    public synchronized static void remove(String key){
        try {
            ...
            LOGGER.error("Remove keyex(String) error : " + e);
        }
    }
    ...
    public synchronized static void remove(byte[] key){
        try {
            ...
            LOGGER.error("Remove keyex(byte[]) error : " + e);
        }
    }
